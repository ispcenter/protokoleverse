...
class Task_model:
	...
	def __init__(self, adress):
		...
		self.serverPath = r'Saukip\Arm{self.stendNumber}\Аттестация\{psYear}...'
		# self. =

#0 Setup
taskFound = False
serverPath = 'Saukip'
container = r'D:\code\python\protokoleverse\Container\\'
...
containerYear = container + f'{psYear}'

if not os.path.exists(containerYear):
   os.makedirs(containerYear)

# 2.2 Создать папку для новой приёмки
containerYearPriemka = containerYear + '\\' + f'{psYear}.{psMonth}.{psDay}'
